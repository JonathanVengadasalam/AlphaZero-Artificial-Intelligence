...
def MANvsAI(rootenv, ai, envlist=[], verbose=0):
...
def AIvsAI(rootenv, iteration, ai1, ai2, xlist=[], ylist=[], resultlist=[], envlist=[], verbose=3):
...
def PositionTest(env, ai, move, iteration=50, verbose=1):
    k = []
    d = time()
    for i in range(iteration):
